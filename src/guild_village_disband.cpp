...
namespace GuildVillage
{
    ...
    {
        // Zjisti phase z DB (preferuj uloženou), jinak fallback výpočet
        ...
        // 2) world spawny pro tuto phase (na naší mapě)
        ...
        // 3) AŽ NAKONEC smaž z customs.gv_guild (sloupec 'guild')
